...
| [MOSS-TTS-Realtime](../cookbook/moss_tts_realtime.md) | `examples/configs/moss_tts_realtime.yaml` | Request-1 low-latency streaming and optional voice cloning via `ref_audio`. Maximum concurrency is 1 |
