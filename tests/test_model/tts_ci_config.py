...
def _continuity_gate(reference_pct: float) -> float:
...
QWEN3_TTS_VC_LATENCY_GATES = TtsCiLatencyPreset(
    points=(
        ...
        TtsCiLatencyPoint(
            ...
            ttfp_p95_max_s=_latency_gate(QWEN3_TTS_LATENCY_VC_R20_TTFP_P95_REF_S),
            c50_min_pct=_continuity_gate(QWEN3_TTS_LATENCY_VC_R20_C50_REF_PCT),
        ),
    ),
    calibrated=True,
)
QWEN3_TTS_CUSTOM_VOICE_LATENCY_GATES = TtsCiLatencyPreset(
    points=(
        ...
        TtsCiLatencyPoint(
            ...
            c50_min_pct=_continuity_gate(
                QWEN3_TTS_LATENCY_CUSTOM_VOICE_R20_C50_REF_PCT
            ),
        ),
    ),
    calibrated=True,
